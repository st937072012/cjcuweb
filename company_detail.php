...
<head>
	...
	<title>公司資料</title>
	<!-- 取得公司資訊 -->
	<script><? include_once("js_company_detail.php"); echo_company_detail_array($company_id); ?></script>
...
<div id="detail"></div>
<script>
//user.user_no,user.name,user.dep_name,s.pic,s.birthday,s.nickname,s.sex,s.phone,s.address,s.email,s.doc
	$(function(){
