...
<body>
<h1>廠商註冊</h1><hr>
<form name="form" method="post" action="register_company.php" onsubmit="return check_data();">
...
負責人性別*：<input  type="radio" name="sex" value="0" checked="true">女
<input  type="radio" name="sex" value="1">男 <br>

公司行業類型 : <select name="company_type" id="company_type"></select><br>
...
公司聯絡地址*：<input type="text" name="address" /> <br>
Email：<input type="text" name="email" /> <br>
公司資本額：<input type="text" name="budget" /> <br>
公司簡介：<br><textarea name="other" cols="45" rows="5"></textarea> <br>
